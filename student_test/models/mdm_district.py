...
class District(models.Model):
    ...
    province_id = fields.Many2one(comodel_name="mdm.province", string=_('รหัสจังหวัด'), required=True)
    province_code= fields.Char(string=_('จังหวัด'), related='province_id.province_code', required=True)
